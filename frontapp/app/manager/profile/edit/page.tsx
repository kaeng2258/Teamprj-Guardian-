                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <label className="flex flex-col gap-1 text-sm text-slate-700 dark:text-slate-200">
                    ...
                    <input
                      ...
                      className={`rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-indigo-500 focus:outline-none ${birthDate ? "text-slate-900" : "text-slate-400"
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/50">
                  ...
                  >
                    <span className="flex items-center gap-2">
                      <span
                        className={`flex h-7 w-7 items-center justify-center rounded-full bg-white/90 shadow-sm ${pushEnabled ? "text-indigo-600" : "text-slate-600"
                          }`}
                      >
                ...
                <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/50">
                  ...
                  >
                    <span className="flex items-center gap-2">
                      <span
                        className={`flex h-7 w-7 items-center justify-center rounded-full bg-white/90 shadow-sm ${theme === "dark" ? "text-indigo-600" : "text-amber-500"
                          }`}
                      >
                ...
                <div className="flex items-center justify-between rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 dark:border-slate-700 dark:bg-slate-900/50">
                  ...
                  >
                    <span className="flex items-center gap-2">
                      <span
                        className={`flex h-7 w-7 items-center justify-center rounded-full bg-white/90 shadow-sm ${textSize === "large" ? "text-indigo-600" : "text-slate-600"
                          }`}
                      >
